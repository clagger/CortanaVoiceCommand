...
namespace WorldPopulation.VoiceCommands
{
    public sealed class VoiceCommandService : IBackgroundTask
    {
                ...
                try
                {
                    ...
                    switch (voiceCommand.CommandName)
                    {
                        case "showFuturePopulation":
                            ...
                            await SendCompletionMessageForDestination(country, year);
                            break;
                        default:
        ...
        private async Task SendCompletionMessageForDestination(string country, string year)
        {
            ...
            responseContentTile.TextLine1 = "Population: " + population.ToString();
